...
const Feature = ({ setFeatureBTN, featureBTN }) => {
    ...
    return (
        <div className="py-12 md:py-20 lg:py-30 space-y-8 md:space-y-12 px-6 md:px-20 lg:px-50 mx-auto">

            <div className="flex flex-col gap-3 md:gap-4"> 
                
                <h1 className="text-[#101727] text-3xl md:text-4xl lg:text-5xl font-extrabold text-center">Premium Digital Tools</h1>
