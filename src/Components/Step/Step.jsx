...
const Step = () => {
    return (
        <div className='flex flex-col gap-6 md:gap-10 py-12 md:py-20 lg:py-30 px-6 md:px-12'>            
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 lg:gap-7.5'>
